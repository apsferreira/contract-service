-- Migration: 006_seed_libri_contract_template.sql
-- Description: Contrato de Assinatura SaaS — Libri (Biblioteca Digital Pessoal)
...
<head>
    ...
    <title>Contrato de Assinatura SaaS — Libri</title>
    <style>
        body { font-family: Arial, sans-serif; line-height: 1.7; max-width: 800px; margin: 0 auto; padding: 20px; color: #1a1a1a; }
        h1 { color: #1f2937; border-bottom: 3px solid #0ea5e9; padding-bottom: 12px; font-size: 1.6rem; }
        h2 { color: #374151; margin-top: 32px; font-size: 1.1rem; text-transform: uppercase; letter-spacing: 0.05em; }
        .destaque { background: #f0f9ff; border-left: 4px solid #0ea5e9; padding: 16px 20px; border-radius: 0 8px 8px 0; margin: 20px 0; }
        ...
        th { background: #e0f2fe; padding: 10px; text-align: left; border: 1px solid #0ea5e9; font-size: 0.9rem; }
...
<body>
    ...
    <h1>Contrato de Assinatura e Serviços SaaS<br>
        <small style="font-size: 0.7em; color: #374151;">Libri — Biblioteca Digital Pessoal com IA</small>
    </h1>

    <div class="destaque">
        <strong>Produto:</strong> Libri · <strong>Versão:</strong> 1.0.0<br>
    ...
    <p>
        O presente contrato tem por objeto a prestação de serviços de biblioteca digital pessoal através da plataforma
        <strong>Libri</strong>, um software como serviço (SaaS) que utiliza inteligência artificial para organização,
        catalogação e recomendação de obras literárias, com funcionalidades de scanner de ISBN, anotações pessoais e listas de leitura.
    </p>

    <h2>3. Descrição do Serviço</h2>
    <p>
        O Libri fornece ao Contratante as seguintes funcionalidades no plano <strong>{{plan_name}}</strong>:
    </p>
    <ul>
        <li>Biblioteca digital pessoal com armazenamento ilimitado (plano Pro)</li>
        <li>Scanner ISBN integrado com reconhecimento automático de obras</li>
        <li>Anotações, marcadores e listas de leitura sincronizadas</li>
        <li>Recomendações inteligentes baseadas em IA</li>
        <li>Acesso mobile via aplicativo (iOS/Android)</li>
        <li>Sincronização entre dispositivos (nuvem)</li>
        <li>Exportação de dados em múltiplos formatos (PDF, EPUB, JSON)</li>
        <li>Suporte por email (resposta em até 48h em dias úteis)</li>
    </ul>
    <div class="plano">
        <strong>Detalhes do Plano Contratado:</strong><br>
        Livros na biblioteca: {{plan_limit_books}}<br>
        Sincronização em nuvem: {{plan_cloud_sync}}<br>
        Recomendações com IA: {{plan_ai_enabled}}<br>
    ...
    <ul>
        <li><strong>Free:</strong> R$ 0,00/mês — biblioteca com até 50 obras, sem IA</li>
        <li><strong>Pro:</strong> R$ 29,00/mês — biblioteca ilimitada, IA incluída, suporte prioritário</li>
    </ul>
    <p>
    ...
    <p>
        Toda a propriedade intelectual da <strong>plataforma Libri</strong> (software, código, design, modelos de IA,
        algoritmos de recomendação) permanece com a IIT. O Contratante recebe licença de uso pessoal, não transferível, limitado à
        duração do contrato.
    </p>
    <p>
        <strong>Conteúdo do Usuário:</strong> Dados de biblioteca, anotações pessoais, listas de leitura e highlights criados
    ...
    <table>
        ...
        <tr>
            <td>Livros, anotações, listas de leitura</td>
        ...
        <tr>
            <td>Dados de leitura (progresso, tempo gasto)</td>
            <td>Recomendações inteligentes e analytics pessoal</td>
    ...
    <h2>10. Direitos do Titular de Dados (Art. 18 LGPD)</h2>
    ...
    <ul>
        ...
        <li><strong>Portabilidade:</strong> exportar biblioteca, anotações e metadados em formato JSON/CSV</li>
        <li><strong>Oposição:</strong> revogar consentimento para uso de dados de recomendação</li>
    </ul>

    <h3>10.1. Retenção de Dados</h3>
    <ul>
    ...
    <h3>10.2. Anonimização</h3>
    <p>
        Após a exclusão dos dados pessoais, dados de leitura (sem associação ao usuário) serão <strong>anonimizados</strong> e poderão
        ser mantidos para fins estatísticos agregados, sem possibilidade de reidentificação do titular.
    </p>

    <h2>11. Exportação de Dados Pós-Cancelamento</h2>
    <p>
        Em caso de cancelamento da assinatura, o Contratante terá <strong>15 (quinze) dias</strong> para exportar sua biblioteca
        (livros, anotações, listas, histórico) através da plataforma em formatos compatíveis (PDF, EPUB, JSON). Após este período,
    ...
    <ul>
        <li>Indisponibilidade temporária de bases de dados de livros (APIs de terceiros)</li>
        <li>Imprecisão ou incompletude nas recomendações geradas por IA</li>
        <li>Interrupções causadas por terceiros (ISPs, provedores de cloud, CDN)</li>
        <li>Uso indevido da plataforma pelo Contratante (violação de direitos autorais, conteúdo ilícito)</li>
        <li>Danos indiretos, lucros cessantes, danos morais (ressalvado o direito do consumidor conforme CDC)</li>
    </ul>

    <h2>13. Segurança e Conformidade</h2>
    <p>
    ...
    <h2>14. Compartilhamento de Dados com Terceiros</h2>
    <p>A IIT <strong>não comercializa dados pessoais</strong>. Compartilhamento ocorre apenas para:</p>
    <ul>
        <li><strong>Provedores de IA:</strong> dados minimizados para recomendações (sem PII quando possível)</li>
    ...
    <p>
        ...
        <strong>Cancelamento pela IIT:</strong> A IIT pode encerrar a conta por violação grave dos termos (conteúdo ilícito,
        abuso do serviço), com aviso prévio de 30 dias, exceto por ilicitude comprovada.
    </p>

    <h2>16. Alterações do Contrato</h2>
    <p>
    ...
    <h2>17. Contato — Encarregado de Dados (DPO)</h2>
    <p>
    ...
    <div class="aviso">
        ...
        todas as cláusulas, concordando expressamente com os termos de prestação do serviço Libri, tratamento de dados
